...
check_var "CASM_CXXFLAGS" "Compiler flags" "-O3 -Wall -fPIC --std=c++11 -DNDEBUG -fdiagnostics-color -Wno-deprecated-register -Wno-ignored-attributes -Wno-deprecated-declarations"
